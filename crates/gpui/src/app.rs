...
use crate::{
    ...
    Keymap, Keystroke, LayoutId, Menu, MenuItem, OwnedMenu, Pixels, Platform, PlatformDisplay,
...
pub struct App {
    ...
    pub(crate) global_action_listeners:
        RapidHashMap<TypeId, Vec<Rc<dyn Fn(&dyn Any, DispatchPhase, &mut Self)>>>,
    ...
    pub(crate) window_invalidators_by_entity:
        RapidHashMap<EntityId, RapidHashMap<WindowId, WindowInvalidator>>,
...
impl App {
    ...
    pub(crate) fn record_entities_accessed(
        ...
        entities: &RapidHashSet<EntityId>,
    ) {
    ...
    pub fn deprecated_actions_to_preferred_actions(
        &self,
    ) -> &RapidHashMap<&'static str, &'static str> {
