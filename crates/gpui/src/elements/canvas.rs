use crate::{App, Bounds, Element, ElementId, GlobalElementId, IntoElement, Pixels, Refineable as _, Style, StyleRefinement, Styled, Window};
...
impl<T: 'static> Element for Canvas<T> {
	...
	fn prepaint(&mut self, _id: Option<&GlobalElementId>, bounds: Bounds<Pixels>, _request_layout: &mut Style, window: &mut Window, cx: &mut App) -> Option<T> {
