...
use windows::Win32::Graphics::{
	Direct3D11::{
		D3D11_BIND_SHADER_RESOURCE, D3D11_BOX, D3D11_TEXTURE2D_DESC, D3D11_USAGE_DEFAULT, ID3D11Device, ID3D11DeviceContext, ID3D11ShaderResourceView,
		ID3D11Texture2D
	},
	Dxgi::Common::*
};
...
impl DirectXAtlasState {
	...
	fn push_texture(&mut self, min_size: Size<DevicePixels>, kind: AtlasTextureKind) -> Option<&mut DirectXAtlasTexture> {
