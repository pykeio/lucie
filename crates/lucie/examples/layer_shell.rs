...
mod example {
	...
	use lucie::{
		App, Application, Bounds, Context, FontWeight, Size, Window, WindowBackgroundAppearance, WindowBounds, WindowKind, WindowOptions, div, layer_shell::*,
		...
		Application::new().run(|cx: &mut App| {
			cx.open_window(
				WindowOptions {
					...
					app_id: Some("lucie-layer-shell-example".to_string()),
					window_background: WindowBackgroundAppearance::Transparent,
					kind: WindowKind::LayerShell(LayerShellOptions {
						namespace: "lucie".to_string(),
