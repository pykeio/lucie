...
pub trait Styled: Sized {
	...
	/// Sets the element to prevent flex items from wrapping, causing inflexible items to overflow the container if
	/// necessary. [Docs](https://tailwindcss.com/docs/flex-wrap#dont-wrap)
